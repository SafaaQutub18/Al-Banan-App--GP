...
#if UNITY_EDITOR_64
         string PluginServerPath = Path.Combine(Application.dataPath,@"Al-Banan-App--GP\PluginServer\x64");
#else
#if UNITY_EDITOR_32
            string PluginServerPath = Application.dataPath + @"\Al-Banan-App--GP\PluginServer\x86";
#else
        //HACK
